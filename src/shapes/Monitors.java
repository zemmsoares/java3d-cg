...
public class Monitors extends Group {
	public Monitors(Appearance pc2App, Appearance pc3App, Appearance plasticApp) {
		...
		// Screen Vertical		
		screen = new Box(0.28f, 0.48f, 0.010f,Box.GENERATE_TEXTURE_COORDS | Box.GENERATE_NORMALS | Box.ENABLE_GEOMETRY_PICKING,pc3App);
